    ...
    <div className="home-main">
      <div className="home-junior-div" >
        <div className="home-main-title">
          ...
          <div className="btn-container">
            <a className="btn-brown" href="https://squareup.com/appointments/book/o8m0jbj28qhofw/Y4XZ4EM2MHW86/start" target="blank" rel='noref'>BOOK NOW</a>
          </div>
        </div>
      </div>
      ...
      <div className="home-barbers">
        <div className="junior-third">
          <div className="junior-name">Junior</div>
